...
def test_input_int_in_np_getitem_by_index():
...
def test_input_int_in_np_getitem_by_rowindex():
    obj = np.array([30, 53, 31, 47, 32])
    df = DataFrame(obj, colindex=["AGE"], rowindex=["A", "B", "C", "D", "E"])
...
def test_input_int_in_np_getitem_wrong():
    obj = np.array([30, 53, 31, 47, 32])
    df = DataFrame(obj, colindex=["AGE"], rowindex=["A", "B", "C", "D", "E"])
...
def test_input_int_in_np_getitem_empty():
    obj = np.array([30, 53, 31, 47, 32])
    df = DataFrame(obj, colindex=["AGE"], rowindex=["A", "B", "C", "D", "E"])
