...
def test_input_mixed_in_dict_of_np_median_even():
    obj = {'age':np.array([30.1, 53.1, 31.1, 47.1, 32.1, 100.0]), 'albums':np.array([4, 10, 2, 5, 4, 100]), 'C':np.array(['a', 'b', 'c', 'd', 'e', 'f']), 'D':np.array([True, False, True, True, False, True])}
    df = DataFrame(obj, colindex = ['AGE', 'ALBUMS', 'C', 'D'], rowindex = ['A', 'B', 'C', 'D', 'E', 'F'])
